			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					...
					case ExampleProximityPlayerNetworkObject.IDENTITY:
						...
						break;
					case GameplayLogicNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new GameplayLogicNetworkObject(networker, id, frame);
						break;
					...
					case PlayerNetworkObject.IDENTITY:
						...
						break;
					case TrainNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new TrainNetworkObject(networker, id, frame);
						break;
				}
